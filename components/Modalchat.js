...
import { doc, onSnapshot, query, orderBy, addDoc, collection, serverTimestamp, updateDoc } from 'firebase/firestore';
              ...
              >
                <div className="flex justify-between">
                  <Dialog.Panel className="flex flex-col items-center justify-between w-full max-w-md transform overflow-hidden rounded-2xl bg-[grey] p-6 text-left align-middle shadow-xl h-[40rem] w-auto transition-all">
                    <Dialog.Title as="h3" className="text-lg font-serif leading-6 text-[black] mt-[5px]">
                      Chat-Box
                    </Dialog.Title>
                    ...
                    <div className="flex gap-1 items-center">
                      <div className="mt-[14px]">
                        <img
                          ...
                          alt=""
                          className="sm:w-8 sm:h-8 sm:rounded-full rounded-full ml-[-6px] w-[7.8rem] h-[2rem]"
                        />
                      </div>
                      <div className="flex md-2 mt-4 h-[2rem]">
                        <input
                          type="text"
                          className="text-md text-[black] outline-0 rounded-[4px]"
                          placeholder="Chat...."
                          value={Comment}
